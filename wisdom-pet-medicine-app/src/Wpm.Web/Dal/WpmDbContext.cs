...
public class WpmDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Pet>().HasData(
                    new Pet() { Id = 1, Name = "Gianni", Age = 10, Weight = 19, PhotoUrl= "https://wisdompetstorage.blob.core.windows.net/petphotos/gianni.jpg", BreedId = 1 },
                    new Pet() { Id = 2, Name = "Nina", Age = 8, Weight = 24, PhotoUrl = "https://wisdompetstorage.blob.core.windows.net/petphotos/nina.jpg", BreedId = 1 },
                    new Pet() { Id = 3, Name = "Cati", Age = 8, Weight = 33.5m, PhotoUrl = "https://wisdompetstorage.blob.core.windows.net/petphotos/cati.jpg", BreedId = 2 },
